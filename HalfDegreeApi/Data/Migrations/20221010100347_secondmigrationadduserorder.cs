...
{
    public partial class secondmigrationadduserorder : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotolPrice = table.Column<double>(type: "float", nullable: false),
                    IsApproved = table.Column<bool>(type: "bit", nullable: false),
                    ApprovedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsDeliverd = table.Column<bool>(type: "bit", nullable: false),
                    DeliverdBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
